...
namespace ProjectProgress.Data.Migrations
{
    ...
    [Migration("20211120070813_Update database and change sql")]
    partial class Updatedatabaseandchangesql
    {
            ...
            modelBuilder.Entity("ProjectProgress.Domain.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2021, 11, 20, 10, 38, 12, 729, DateTimeKind.Local), Name = "admin" },
                        new { Id = 2, CreatedDate = new DateTime(2021, 11, 20, 10, 38, 12, 731, DateTimeKind.Local), Name = "user" }
                    );
                });
            ...
            modelBuilder.Entity("ProjectProgress.Domain.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2021, 11, 20, 10, 38, 12, 738, DateTimeKind.Local), Password = "VXJxe6tL/6h38wrtnaPOT9noYzmeMjjfmAmo9pbRj59ItP+qnOp9hHyDkAwa2Fd4AJLX9/vcJTplYwo+DjeFIfTTmXtP/Q==", Salt = "zjRX5IwwHNrkVuPzC4NvLWwQ+aesBFkcdHXUMkz6iIp+IuqGZh3nf+j9JKDgwbxWNEWkcxKyyZl2xHb02avQb0bSuRhuzw==", UserName = "admin" }
                    );
                });
