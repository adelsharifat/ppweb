...
namespace ProjectProgress.Data.Migrations
{
    ...
    [Migration("20211115070946_Update Attachment Table")]
            ...
            modelBuilder.Entity("ProjectProgress.Domain.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2021, 11, 15, 10, 39, 46, 322, DateTimeKind.Local), Name = "admin" },
                        new { Id = 2, CreatedDate = new DateTime(2021, 11, 15, 10, 39, 46, 324, DateTimeKind.Local), Name = "user" }
                    );
                });
            ...
            modelBuilder.Entity("ProjectProgress.Domain.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2021, 11, 15, 10, 39, 46, 331, DateTimeKind.Local), Password = "cdsoYPl+MWBqH+1XdAHFdWcTSPlzYBcAK6FW6gPmy3nG2NHQuULab3QbBj5n2kZUg9mV/ZLxFHIpcKNjGKaA2JgqJnLnvw==", Salt = "Qi6944nX33DydxF1rxhJR+rgXVImhRcQNw/1BX1uMmTIPk+V1rajxipjtZmxBDyLVlZNAXJoOOE6GQeW+KKm4cPl81LByQ==", UserName = "admin" }
                    );
                });
