...
namespace ProjectProgress.Data.Migrations
{
    ...
    [Migration("20211027121337_Initial Migration")]
            ...
            modelBuilder.Entity("ProjectProgress.Domain.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2021, 10, 27, 15, 43, 37, 449, DateTimeKind.Local), Name = "admin" },
                        new { Id = 2, CreatedDate = new DateTime(2021, 10, 27, 15, 43, 37, 451, DateTimeKind.Local), Name = "user" }
                    );
                });
            ...
            modelBuilder.Entity("ProjectProgress.Domain.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2021, 10, 27, 15, 43, 37, 461, DateTimeKind.Local), Password = "YGiiWc7FTrrY8Kr8nLJ6DCVXbsGnAzpP6F0+84T+Jn0h7c6T2S5aIedS1MYSHoU8Sgyr5eVtxzDPLe1k6/Pw6FCteXv1dQ==", Salt = "RwcG0+iyE3HSNNT8LSbdREt8TQamv404f2h0A0hIzp3x0YdqcVHetWk5IgleJAgtPHh++hFtQIC9++9bnNMWiXDOZIYRHw==", UserName = "admin" }
                    );
                });
