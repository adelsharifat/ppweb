...
namespace ProjectProgress.Data.Migrations
{
    ...
    [Migration("20220104035606_added_attachmentDate_column_table_attachment")]
    partial class added_attachmentDate_column_table_attachment
    {
            ...
            modelBuilder.Entity("ProjectProgress.Domain.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2022, 1, 4, 7, 26, 5, 931, DateTimeKind.Local), IsAdmin = false, Password = "ISMvKXpXpadDiUoOSoAfww==", SeenDesktopMode = false, UserName = "admin" }
                    );
                });
